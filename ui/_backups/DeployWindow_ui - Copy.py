...
""))
        ...
        self.buttonAccept_2 = QtGui.QPushButton(DeployWindow)
        self.buttonAccept_2.setGeometry(QtCore.QRect(230, 140, 81, 31))
        self.buttonAccept_2.setObjectName(_fromUtf8("buttonAccept_2"))
    ...
    def retranslateUi(self, DeployWindow):
        ...
        self.buttonAccept_2.setText(_translate("DeployWindow", "Cancel", None))
